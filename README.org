...
Note: Version 29.2 has been released. The inline patch (emacs-29.1-inline.patch) is applicable to Emacs 29.2. Installer packages for Intel-based Mac and Apple Silicon Mac are also available. You may install them in macOS Catalina or later.
...
- Emacs 29.1, 29.2 (emacs-29.1-inline.patch)
...
You can download my pre-built Emacs 26.3, 27.1, 27.2, 28.1, 28.2, 29.1, =29.2= and HEAD with ns-inline patch. =Emacs.app= will be installed under =/Applications/Emacs-takaxp= in your macOS. The pkg contains =GnuTLS= and =jansson=. These packages are signed and notarized with my Apple developer ID: =H2PH8KNN3H=.
...
|-------+---------+------------------+--------+----------------------------------|
| Apple | 30.0.50 | [[https://pxaka.tokyo/emacs/pkg/emacs-head_apple.pkg][⬇pkg]] (10FEB2024) | Sonoma | [[https://pxaka.tokyo/emacs/pkg/emacs-head_apple.md5][74541ddf90ff45dd0a9562464d8f15a6]] |
| Intel | 30.0.50 | [[https://pxaka.tokyo/emacs/pkg/emacs-head_intel.pkg][⬇pkg]] (10FEB2024) | Sonoma | [[https://pxaka.tokyo/emacs/pkg/emacs-head_intel.md5][8f02085b810f7973fe1888efcd917c95]] |
...
| Chip  | Version | Download               | macOS             | [MB] | md5                              |
|-------+---------+------------------------+-------------------+------+----------------------------------|
| Apple |    29.2 | [[https://pxaka.tokyo/emacs/pkg/emacs-29.2_intel_pure.pkg][⬇pure.pkg]] (2024-01-21) | Sonoma[*1]        | 59.5 | [[https://pxaka.tokyo/emacs/pkg/emacs-29.2_apple_pure.md5][7eaeabb13aaf141203929fd9641c4189]] |
