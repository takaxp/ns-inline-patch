...
Note: Version 28.1 has been released. The inline patch (emacs-28.1-inline.patch) is newly generated for Emacs 28.1. Installer packages for Intel-based Mac and Apple Silicon M1 Mac will be available soon from this repository (possibly middle of April).
