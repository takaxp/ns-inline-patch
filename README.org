...
*Note:* You may need to allow to install the downloaded Emacs by accepting third party applications in "System Preferences" > "Security & Privacy". Please click "Open Anyway" to install pre-built packages.
