...
You can download my pre-built Emacs 26.3 and 27.2 with ns-inline patch. =Emacs.app= will be installed under =/Applications/Emacs-takaxp= in your macOS. The pkg contains =GnuTLS= and =jansson=. Then support Big Sur only.
